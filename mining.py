...
def six_best_months(monthly_averages):
    """
...
def six_worst_months(monthly_averages):
    """
    Using the monthly averages generated by red_stock_data, generates a list of the six worst performing months
    by volume and capacity
    (lst) -> (tup, le)
    :return: worstt_six, a list of the six best performing months of monthly_averages
    """
